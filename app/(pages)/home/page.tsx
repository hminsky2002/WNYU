...
export default async function Home() {
  ...
  return (
    <div>
      <div className="flex-col space-y-10 md:grid md:grid-cols-3 md:grid-rows-6 md:space-x-12 md:space-y-0">
        <div className="h-[200px] md:col-span-2 md:row-span-5 md:ml-8 md:h-full">
